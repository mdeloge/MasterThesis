...
public class StreamingPipeline {
	...
	public static void main(String[] args) {
		String sourceTopic = "projects/projectID/subscriptions/dataflow_subscription";
		...
		String sideSource = "gs://bucketID/sync_list/Jouleboulevard_metadata.csv";
		String unParseableDataDest = projectID + ":" + datasetID + "." + ".EnergieID_unParseable";
